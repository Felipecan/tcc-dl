...
parser.add_argument('--spect', action='store', dest='spect_folders', default='../dados/spect', required='training' in sys.argv, help='Nome/caminho da pasta contendo as pastas com os espectrogramas.')
...
parser.add_argument('--audio', action='store', dest='audio_folders', default='../dados/pac-audios', required='all_proc' in sys.argv, help='Nome/caminho da pasta contendo as pastas com os áudios.')
arguments = parser.parse_args()

if(arguments.mode == 'training'):
    print("Entering on training mode...")
    vgg19 = VGG19()
    vgg19.config_dataset(arguments.spect_folders)    
    vgg19.train()
else:
    ...
    vgg19 = VGG19()
    vgg19.config_dataset(path_spect)    
    vgg19.train()